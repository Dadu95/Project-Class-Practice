...
public class ContactServiceTest {
	...
	public void test_findByName() {
		...
		PowerMockito.when(dao.findByName("Ashok")).thenReturn(new Contact("Ashok", 123456L));

		ContactService service = new ContactService();
		service.setDao(dao);

		Contact c = service.getByName("Ashok");
	...
	@Test
	public void test_printMessage2_privateMethod() throws Exception {
